...
namespace TensorFlowNET.Examples.ImageProcess
{
    ...
    public class RetrainImageClassifier : IExample
    {
        ...
        string output_graph = Path.Join(transfer_learning_assets_dir, "my_custom_retrained_model.pb");
        string output_labels = Path.Join(transfer_learning_assets_dir, "my_custom_labels_list.txt");
        ...
        public void Predict(Session sess_)
        {
            ...
            // predict image
            var img_path = Path.Join(images_folder_for_predicting, "BlackRose.png"); //BlackRose.png // RareThreeSpiralledRose.png
