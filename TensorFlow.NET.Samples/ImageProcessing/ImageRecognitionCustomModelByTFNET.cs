...
{
    public class ImageRecognitionCustomModelByTFNET : IExample
    {
        public bool Enabled { get; set; } = true;
        public string Name => "Image Recognition Custom Model created with Transfer Learning Retrain with TensorFlow.NET";
        ...
        string pbFile = "tfdotnet_custom_chair_image_classification_model.pb";
        string labelFile = "tfdotnet_custom_chair_image_classification_labels_list.txt";
        //
        ////////////////////////////////////////////////////////////////////
        ...
        string input_name = "Placeholder"; //OLD in Inceptionv3: "import/input";
        string output_name = "final_result"; //OLD in Inception v3 "import/InceptionV3/Predictions/Reshape_1";
